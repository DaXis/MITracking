...
class ProgressHttpEntityWrapper extends HttpEntityWrapper {
    ...
    public ProgressHttpEntityWrapper(final MultipartEntity entity, final ProgressCallback progressCallback) {
        super(entity);
    ...
    public void writeTo(final OutputStream out) throws IOException {
        this.wrappedEntity.writeTo(out instanceof ProgressFilterOutputStream ?
                out : new ProgressFilterOutputStream(out, this.progressCallback, getContentLength()));
    }
