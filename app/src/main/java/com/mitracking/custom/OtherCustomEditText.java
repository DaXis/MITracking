...
import com.mitracking.interfaces.DrawableClickListener;

public class OtherCustomEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    public OtherCustomEditText(Context context) {
        super(context);
        init();
    }

    public OtherCustomEditText (Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public OtherCustomEditText(Context context, AttributeSet attrs, int defStyle) {
